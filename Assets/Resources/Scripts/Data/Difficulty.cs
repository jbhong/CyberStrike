...
public static class Difficulty
{
    ...
    public static void SetDifficulty(int _dificulty)
    {
        ...
        switch (difficulty)
        {
            case 0:
                {
                    variables["minutes"] = "8.0";
                    variables["enemyspawn"] = "4.0";
                    variables["enemydamage"] = "5";
                    variables["enemyhealth"] = "30";
                    break;
                }
            case 1:
                {
                    variables["minutes"] = "6.0";
                    variables["enemyspawn"] = "5.0";
                    variables["enemydamage"] = "10";
                    variables["enemyhealth"] = "60";
                    break;
                }
            case 2:
                {
                    variables["minutes"] = "5.0";
                    variables["enemyspawn"] = "6.0";
                    variables["enemydamage"] = "15";
                    variables["enemyhealth"] = "90";
                    break;
                }
        }
        SetLevel(level);
